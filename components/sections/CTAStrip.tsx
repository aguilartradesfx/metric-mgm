...
export function CTAStrip() {
  return (
    <section className="py-20 pb-30">
      <Container>
        <Reveal>
          <div className="glass-card-dark grid grid-cols-[1.4fr_auto] gap-12 items-center p-16" style={{ borderRadius: 28, background: 'rgba(30, 22, 17, 0.76)', backdropFilter: 'blur(32px) saturate(180%)', WebkitBackdropFilter: 'blur(32px) saturate(180%)' }}>
            {/* Glow decorations */}
            ...
            <div className="relative z-10">
              <h2 className="text-display-2 font-medium text-cream-light mb-4"
              ...
              <p className="text-body-lg" style={{ color: 'rgba(245,238,226,0.80)', maxWidth: 540 }}>
            ...
            <div className="relative z-10 flex-shrink-0">
              <Link href="/contact"
                className="inline-flex items-center gap-2.5 px-7 py-[18px] rounded-full text-body font-medium transition-all duration-300 hover:-translate-y-0.5 whitespace-nowrap"
